...
namespace Memory
{
    public class Level1 : PlatformerLevel
    {
        ...
        protected override void BuildWorld()
        {
            ...
            AddDecoration("level2_2.png", 0, floorY - 750, 1000, 750);
            ...
            AddDecoration("level2_1.png", 6900, floorY - 750, 1000, 750);
            // Воспоминания
            ...
            dialogueMemoryIndex.Add(0);

            dialogueTriggers.Add(new RectangleF(5800, floorY - 480, 100, 80));
            dialogueTexts.Add(new string[] { "Я обожала какао с молоком!", "Могла выпить 5 кружек за раз." });
            dialogueDone.Add(false);
            dialogueMemoryIndex.Add(1);

            dialogueTriggers.Add(new RectangleF(5220, floorY - 208, 100, 80));
            ...
            dialogueDone.Add(false);
            dialogueMemoryIndex.Add(2);

            // Дверь
            doorTrigger = new RectangleF(7900, floorY - 200, 100, 200);
        }
    }
}